...
public sealed class BackgroundTaskStepHandler
{
    ...
    public Task HandleProcessableStepAsync(IPersistentProcessStep step, IEnumerable<IPersistentProcess> data, CancellationToken cToken) => _handlers.ContainsKey(step.Id)
    ...
    public Task<IReadOnlyCollection<IPersistentProcess>> HandleProcessableStepAsync(IPersistentProcessStep step, CancellationToken cToken) => _handlers.ContainsKey(step.Id)
